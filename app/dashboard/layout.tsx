...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/sag", label: "Min sag", icon: FileText, exact: false },
  { href: "/dashboard/dokumenter", label: "Dokumenter", icon: FolderOpen, exact: false },
  { href: "/dashboard/beskeder", label: "Beskeder", icon: MessageSquare, exact: false },
  { href: "/dashboard/indstillinger", label: "Indstillinger", icon: Settings, exact: false },
];
